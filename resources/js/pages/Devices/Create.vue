    ...
    <div class="flex flex-1 flex-col gap-6 p-6 max-w-2xl mx-auto w-full">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-muted-foreground">Register a new SmartGuard hardware unit.</p>
            </div>
        </div>
        ...
        <Card>
            <CardHeader>
                ...
                <CardDescription>Enter the details for the new SmartGuard device.</CardDescription>
            </CardHeader>
            <CardContent>
